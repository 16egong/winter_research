...
def get_sitemap():
    ...
    if get_sitemap.sitemap is None:
        get_sitemap.sitemap = {
            "0.0": {
                "type": "wait",
                "english": url_for("static", filename=f"docs/{config.TYPE}/phase_0.0_EN_wait.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_0.0_CN_wait.pdf"),
                "next": url_for("control", phase=1, subphase=0),
            },
            "1.0": {
                "type": "user_specific_instructions",
                "user1": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_1_CN_instructions.pdf"),
                "user2": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_2_CN_instructions.pdf"),
                "user3": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_3_EN_instructions.pdf"),
                "user4": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_4_EN_instructions.pdf"),
                "user12": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_1_CN_instructions.pdf"),
                "user34": url_for("static", filename=f"docs/{config.TYPE}/phase_1.0_user_3_EN_instructions.pdf"),
                "next": url_for("control", phase=1, subphase=1),
            },
            "1.1": {
                "type": "instructions",
                "english": url_for("static", filename=f"docs/{config.TYPE}/phase_1.1_EN_instructions.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_1.1_CN_instructions.pdf"),
                "next": url_for("control", phase=1, subphase=2),
            },
            "1.2": {
                "type": "special_instructions",
                "user1": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_1_CN_instructions.pdf"),
                "user2": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_2_CN_instructions.pdf"),
                "user3": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_3_EN_instructions.pdf"),
                "user4": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_4_EN_instructions.pdf"),
                "user12": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_1_CN_instructions.pdf"),
                "user34": url_for("static", filename=f"docs/{config.TYPE}/phase_1.2_user_3_EN_instructions.pdf"),
                "english_1": url_for("static", filename=f"docs/{config.TYPE}/phase_1.3_EN_instructions.pdf"),
                "mandarin_1": url_for("static", filename=f"docs/{config.TYPE}/phase_1.3_CN_instructions.pdf"),
                "english_2": url_for("static", filename=f"docs/{config.TYPE}/phase_1.4_EN_instructions.pdf"),
                "mandarin_2": url_for("static", filename=f"docs/{config.TYPE}/phase_1.4_CN_instructions.pdf"),

                "next": url_for("control", phase=1, subphase=5),
            },
            "1.5": {
                "type": "instructions",
                "english": url_for("static", filename=f"docs/{config.TYPE}/phase_1.5_EN_instructions.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_1.5_CN_instructions.pdf"),
            ...
            "1.6": {
                ...
                "english_survey_keys": "https://umdsurvey.umd.edu/jfe/form/SV_9GNloJprQ6TOcS1", 
                "mandarin_survey_keys": "https://umdsurvey.umd.edu/jfe/form/SV_0kXNiJlBE7AY8jH",
                "english_survey_no_keys": "https://umdsurvey.umd.edu/jfe/form/SV_3C4vUzD0E4dLhAh", 
                "mandarin_survey_no_keys": "https://umdsurvey.umd.edu/jfe/form/SV_3rg6UwZInTbW6W1",
                "next": url_for("control", phase=2, subphase=0),
            },
            "2.0": {
                "type": "instructions",
                "english": url_for("static", filename=f"docs/{config.TYPE}/phase_2.0_EN_instructions.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_2.0_CN_instructions.pdf"),
                "next": url_for("control", phase=2, subphase=1),
            },
            "2.1": {
                "type": "chat",
                "roomtype": "separate",
                "1cv1": url_for('static', filename=f'docs/{config.TYPE}/user1_CV1.pdf'),
                "1cv2": url_for('static', filename=f'docs/{config.TYPE}/user1_CV2.pdf'),
                "1cv3": url_for('static', filename=f'docs/{config.TYPE}/user1_CV3.pdf'),
                "1cv4": url_for('static', filename=f'docs/{config.TYPE}/user1_CV4.pdf'),
                "2cv1": url_for('static', filename=f'docs/{config.TYPE}/user2_CV1.pdf'),
                "2cv2": url_for('static', filename=f'docs/{config.TYPE}/user2_CV2.pdf'),
                "2cv3": url_for('static', filename=f'docs/{config.TYPE}/user2_CV3.pdf'),
                "2cv4": url_for('static', filename=f'docs/{config.TYPE}/user2_CV4.pdf'),
                "3cv1": url_for('static', filename=f'docs/{config.TYPE}/user3_CV1.pdf'),
                "3cv2": url_for('static', filename=f'docs/{config.TYPE}/user3_CV2.pdf'),
                "3cv3": url_for('static', filename=f'docs/{config.TYPE}/user3_CV3.pdf'),
                "3cv4": url_for('static', filename=f'docs/{config.TYPE}/user3_CV4.pdf'),
                "4cv1": url_for('static', filename=f'docs/{config.TYPE}/user4_CV1.pdf'),
                "4cv2": url_for('static', filename=f'docs/{config.TYPE}/user4_CV2.pdf'),
                "4cv3": url_for('static', filename=f'docs/{config.TYPE}/user4_CV3.pdf'),
                "4cv4": url_for('static', filename=f'docs/{config.TYPE}/user4_CV4.pdf'),
                "12cv1": url_for('static', filename=f'docs/{config.TYPE}/user1_CV1.pdf'),
                "12cv2": url_for('static', filename=f'docs/{config.TYPE}/user1_CV2.pdf'),
                "12cv3": url_for('static', filename=f'docs/{config.TYPE}/user1_CV3.pdf'),
                "12cv4": url_for('static', filename=f'docs/{config.TYPE}/user1_CV4.pdf'),
                "34cv1": url_for('static', filename=f'docs/{config.TYPE}/user3_CV1.pdf'),
                "34cv2": url_for('static', filename=f'docs/{config.TYPE}/user3_CV2.pdf'),
                "34cv3": url_for('static', filename=f'docs/{config.TYPE}/user3_CV3.pdf'),
                "34cv4": url_for('static', filename=f'docs/{config.TYPE}/user3_CV4.pdf'),
                "chat": False,
            ...
            "3.0": {
                "type": "instructions",
                "english": url_for('static', filename=f"docs/{config.TYPE}/phase_3.0_EN_instructions.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_3.0_CN_instructions.pdf"),
            ...
            "4.0": {
                "type": "instructions",
                "english": url_for('static', filename=f"docs/{config.TYPE}/phase_4.0_EN_instructions.pdf"),
                "mandarin": url_for("static", filename=f"docs/{config.TYPE}/phase_4.0_CN_instructions.pdf"),
            ...
            "5.0": {
                ...
                "english_survey_keys": "https://umdsurvey.umd.edu/jfe/form/SV_a2G2lwHNjunGxEh",
                "mandarin_survey_keys": "https://umdsurvey.umd.edu/jfe/form/SV_8uY0btETeSq2UKh",
                "english_survey_no_keys": "https://umdsurvey.umd.edu/jfe/form/SV_26mNQd3WkeiodgN",
                "mandarin_survey_no_keys": "https://umdsurvey.umd.edu/jfe/form/SV_1LjO5LfbsEjdUjz",
                "next": None,
            },
        }
