    ...
    if get_sitemap.sitemap is None:
        get_sitemap.sitemap = {
            ...
            "4.1": {
                "type": "chat",
                "roomtype": "separate",
                "u1cv1": url_for('static', filename='imgs/user1_CV1.pdf'),
                "u1cv2": url_for('static', filename='imgs/user1_CV2.pdf'),
                "u1cv3": url_for('static', filename='imgs/user1_CV3.pdf'),
                "u1cv4": url_for('static', filename='imgs/user1_CV4.pdf'),
                "u2cv1": url_for('static', filename='imgs/user2_CV1.pdf'),
                "u2cv2": url_for('static', filename='imgs/user2_CV2.pdf'),
                "u2cv3": url_for('static', filename='imgs/user2_CV3.pdf'),
                "u2cv4": url_for('static', filename='imgs/user2_CV4.pdf'),
                ...
                "u4cv1": url_for('static', filename='imgs/user4_CV1.pdf'),
                "u4cv2": url_for('static', filename='imgs/user4_CV2.pdf'),
                "u4cv3": url_for('static', filename='imgs/user4_CV3.pdf'),
                "u4cv4": url_for('static', filename='imgs/user4_CV4.pdf'),
...
def control(phase, subphase):
    ...
    if site["type"] == "user_specific_instructions":
        ...
        return render_template(
            ...
            uid=uid, 
            username=username, 
            cv1=site["u"+str(uid)+"cv1"], 
            cv2=site["u"+str(uid)+"cv2"], 
            cv3=site["u"+str(uid)+"cv3"], 
            cv4=site["u"+str(uid)+"cv4"], 
            room=room,
            posts=posts,
            notes=notes,
            next=site["next"],
